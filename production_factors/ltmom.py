...
class LongTermMomentum(AbstractFactor):
    ...
    def compute(self, date: DateTime) -> pd.DataFrame:
        ...
        omit_days = cns.DAYS_IN_MONTH
        lookback_days = 12 * cns.DAYS_IN_MONTH
...
if __name__ == "__main__":
    factor = LongTermMomentum(Region("IN"))
    df = factor.compute(DateTime("20200101"))
    print(df)

    factor.backfill(DateTime("20250301"), DateTime("20260301"))
